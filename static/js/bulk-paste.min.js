                            ...
                            <div class="bulk-paste-preview">
                                ...
                                <div class="bulk-paste-preview__table-wrapper">
                                    <table class="bulk-paste-preview__table">
                                        ...
                                        <tbody class="bulk-paste-preview__tbody"></tbody>
                                    </table>
                                </div>
                                <div class="bulk-paste-warnings" style="display: none;"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    parseData(text) {
        ...
        lines.forEach((line, lineIndex) => {
            ...
            if (cells.length !== this.fields.length) {
                errors.push(`الصف ${lineIndex + 1}: عدد الأعمدة غير متطابق (متوقع: ${this.fields.length}, فعلي: ${cells.length})`);
                return;
            }
            const row = {};
