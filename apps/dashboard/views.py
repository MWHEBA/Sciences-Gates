        ...
        if lead_type_filter == LeadType.REGISTRATION:
            ...
            for lead in queryset:
                writer.writerow([
                    ...
                    lead.source_page_decoded,
                    lead.traffic_source_display,
    ...
    def get_context_data(self, **kwargs):
        ...
        sections_config = [
            ...
            },
            {
                ...
                'description': 'الجامعات المعروضة في قسم النخبة بالصفحة الرئيسية (3 خانات)',
                'max_slots': 3,
                'type': 'university',
            ...
            },
            {
                ...
                'description': 'المعاهد المعروضة في قسم معاهد اللغة بالصفحة الرئيسية (خانتان)',
                'max_slots': 2,
                'type': 'institute',
                'pool': Institute.objects.filter(publish_status='published').order_by('order', 'name'),
            },
            {
                ...
                'description': 'التخصصات المعروضة في قسم التخصصات بالصفحة الرئيسية (خانتان)',
                'max_slots': 2,
                'type': 'major',
