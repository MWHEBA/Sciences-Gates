    ...
    class Meta:
        ...
        widgets = {
            ...
            'facebook': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://facebook.com/sciencesgates',
                'dir': 'ltr',
            }),
            'instagram': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://instagram.com/sciencesgates',
                'dir': 'ltr',
            }),
            'twitter': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://x.com/sciencesgates',
                'dir': 'ltr',
            }),
            'youtube': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://youtube.com/@sciencesgates',
                'dir': 'ltr',
            }),
            'linkedin': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://linkedin.com/company/sciencesgates',
                'dir': 'ltr',
            }),
            'tiktok': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://tiktok.com/@sciencesgates',
                'dir': 'ltr',
            }),
            'telegram': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://t.me/sciencesgates',
                'dir': 'ltr',
            }),
            'snapchat': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'https://snapchat.com/add/sciencesgates',
                'dir': 'ltr',
            }),
        ...
        labels = {
            ...
            'facebook': 'رابط صفحة فيسبوك (Facebook)',
            'instagram': 'رابط حساب انستغرام (Instagram)',
            'twitter': 'رابط حساب منصة X (تويتر)',
            'youtube': 'رابط قناة يوتيوب (YouTube)',
            'linkedin': 'رابط صفحة لينكد إن (LinkedIn)',
            'tiktok': 'رابط حساب تيك توك (TikTok)',
            'telegram': 'رابط قناة/حساب تليجرام (Telegram)',
            'snapchat': 'رابط حساب سناب شات (Snapchat)',
        ...
        help_texts = {
            ...
            'email': 'البريد الإلكتروني الأساسي للموقع (يستقبل تلقائياً إشعارات طلبات التسجيل والاستفسارات).',
            'whatsapp': 'أدخل الرقم الدولي بدون مفتاح + أو أصفار (مثال: 966500000000)',
            'facebook': 'رابط الصفحة الرسمية على فيسبوك',
            'instagram': 'رابط الحساب الرسمي على انستغرام',
            'twitter': 'رابط الحساب الرسمي على منصة X (تويتر)',
            'youtube': 'رابط القناة الرسمية على يوتيوب',
            'linkedin': 'رابط الصفحة الرسمية على لينكد إن',
            'tiktok': 'رابط الحساب الرسمي على تيك توك',
            'telegram': 'رابط الحساب أو القناة الرسمية على تليجرام',
            'snapchat': 'رابط الحساب الرسمي على سناب شات',
